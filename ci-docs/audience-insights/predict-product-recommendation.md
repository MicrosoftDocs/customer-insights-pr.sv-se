...
Produktrekommendationer kan omfattas av lokala lagar och regler samt kundens förväntningar, som modellen inte är utformad för att specifikt ta med i beräkningen.  Som användare av denna förutsägelsefunktion **måste du granska rekommendationer innan du levererar dem till dina kunder** för att säkerställa att du följer alla gällande lagar och regler, samt uppfyller kundens förväntningar på det du rekommenderar. 

Dessutom ger utdata från den här modellen rekommendationer baserat på produkt-ID. Leveransmekanismen måste ta med produkt-ID och mappa dem till rätt innehåll så att kunderna kan ta hänsyn till lokalisering, bildinnehåll och annat företagsspecifikt innehåll eller beteende.
...
- Data om transaktioner, inköp och deras historik:
    ...
    - (Valfritt) Produkt-ID-information för transaktionen.
    ...
    - Det semantiska dataschemat kräver följande information:
        ...
        - (Valfritt) **Köp eller retur:** Ett sant/falskt-fält som identifierar om transaktionen var en retur eller inte. Om **värdet för transaktionen** är negativt används även den här informationen för att härleda en retur.
...
1. Om du har valt att *inte* rekommendera nyligen köpta produkter ställer du in **fönstret Se tillbaka**. Den här inställningen anger tidsramen som modellen tar i beaktande innan produkten rekommenderas till användaren igen. Ange till exempel att en kund köper en bärbar dator varannat år. I det här fönstret visas inköpshistoriken för de senaste två åren och om de hittar ett objekt filtreras objektet från rekommendationerna.
...
1. Det finns tre primära dataområden på resultatsidan:
    ...
    1. **De flesta föreslagna produkterna (med summa):** De fem produkter som förutsetts mest för dina kunder.
       > [!div class="mx-imgBorder"]
