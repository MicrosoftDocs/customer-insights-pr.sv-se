...
1. Ange en frekvens för att träna om modellen. Den här inställningen är viktig för att uppdatera precisionen för förutsättningar eftersom nya data förs in i Customer Insights. De flesta företag kan träna om en gång i månaden och få en god exakthet för sina förutsägelser.
1. Välj **Nästa**.
