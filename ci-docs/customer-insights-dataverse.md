...
Administratörer kan konfigurera Customer Insights för [att använda en befintlig Dataverse-miljö](create-environment.md) när de skapar en Customer Insights-miljö. Genom att tillhandahålla webbadressen till Dataverse miljön, det kopplar till deras nya Customer Insights-miljö. Customer Insights och Dataverse-miljöer måste finnas i samma region. 
...
> [!NOTE]
> Om organisationen redan använder Dataverse i sin klientorganisation är det viktigt att komma ihåg att skapandet av [Dataverse-miljön styrs av en administratör](/power-platform/admin/control-environment-creation). Om du till exempel ställer in en ny Customer Insights-miljö med ditt organisationskonto och administratören har inaktiverat skapandet av Dataverse utvärderingsmiljöer för alla utom administratörer, kan du inte skapa en ny utvärderingsmiljö.
> 
